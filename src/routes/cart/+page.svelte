...
<header id="site-header">
  ...
  <footer id="site-footer">
    <div class="container clearfix">
      ...
      <div class="left">
        <h2 class="subtotal">Subtotal: <span>10.750.000đ</span>€</h2>
        <h3 class="tax">Taxes (5%): <span>250.000</span>đ</h3>
        <h3 class="shipping">Shipping: <span>500.000</span>đ</h3>
      </div>

      <div class="right">
        <h1 class="total">Total: <span>11.500.000</span>đ</h1>
        <a class="btn">Mua</a>
      </div>
